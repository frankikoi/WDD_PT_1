            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="blank.html">PT1 WEB Development</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                    ...
                    $user_dateBirth = test_input($_POST["date"]);
                ...
                <br class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">PT1 Web Development</h1>
                    ...
                    <table border="0px">
                        ...
                        <tr>
                       <td>Gender: </td>
                        <td> <select type = "select" name = "gender" id="gender" required>
                                    <option name = "gender" required> </option>
                        ...
                        <tr>
                            <td> Date of Birth</td>
                            <td><input type="date" name="date" min=""  max="12-12-2100" required></td>
                        </tr>
                        <tr>
                       <td>Address</td> 
                       ...
                       <tr>
                        ...
                        <tr>
                        <td>Password </td>
                          <td>  <input type = "password" name = "password" minlength = "8" required ></td> </tr>
                          <td>Confirm Password </td>
                          <td>  <input type = "password" name = "confirm_password" minlength = "8" required></td> </tr>
                       <td></td>
                ...
                <br>
                <?php
                echo "<h1>Registered Data: </h1>";
                echo "Name: " . $user_Fname . " " .  $user_Lname . "</br>";
                echo "Gender: " . $gender . "</br>";
                echo "Date of Birth: " . $user_dateBirth. "</br>";
